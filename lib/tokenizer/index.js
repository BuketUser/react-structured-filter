...
var Tokenizer = function (_Component) {
  ...
  function Tokenizer() {
    ...
    _this._getCategory = _this._getCategory.bind(_this);
    return _this;
  }
  ...
  _createClass(Tokenizer, [{
    ...
    key: '_getCategory',
    value: function _getCategory(category) {
      var cat = category;
    ...
    key: '_getCategoryValidation',
    value: function _getCategoryValidation(category) {
    ...
    value: function renderTypeahead(classList) {
      ...
      return _react2.default.createElement(WrappedTypeahead, { ref: function ref(comp) {
        ...
        isChangeValid: this.state.category !== '' && this.state.operator !== '' ? this._getCategoryValidation() : undefined
      });
    }
  }, {
    key: 'render',
