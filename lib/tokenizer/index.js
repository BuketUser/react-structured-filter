...
var Tokenizer = function (_Component) {
  ...
  _createClass(Tokenizer, [{
    ...
    value: function _onKeyDown(event) {
      // enter case
      if (event.keyCode === _keyevent2.default.DOM_VK_ENTER || event.keyCode === _keyevent2.default.default.DOM_VK_RETURN) {
        if (this.state.category === '') {
...
Tokenizer.propTypes = {
  ...
  */
  onFullEnter: _react.PropTypes.func,
  /**
   ...
   * ```
   */
  operatorSigns: _react.PropTypes.object
};
