...
var Typeahead = function (_Component) {
  ...
  _createClass(Typeahead, [{
    ...
    value: function setEntryText(value) {
      if (this.entry != null) {
        _reactDom2.default.findDOMNode(this.entry).value = value;
      }
    ...
    value: function _onOptionSelected(option) {
      var nEntry = _reactDom2.default.findDOMNode(this.entry);
      nEntry.focus();
      nEntry.value = option;
      this.setState({
    ...
    value: function _onTextEntryUpdated() {
      var value = '';
      if (this.entry != null) {
        value = _reactDom2.default.findDOMNode(this.entry).value;
      }
      if (typeof this.props.isChangeValid === 'function' && this.props.isChangeValid(value) === false) {
        return null;
      }
      this.setState({
    ...
    value: function _onTab() {
      var option = this.sel.state.selection ? this.sel.state.selection : this.state.visible[0];
    ...
    value: function eventMap() {
      ...
      events[_keyevent2.default.DOM_VK_UP] = this.sel.navUp;
      events[_keyevent2.default.DOM_VK_DOWN] = this.sel.navDown;
    ...
    value: function render() {
      ...
      if (this._showDatePicker()) {
        ...
        if (!defaultDate.isValid()) defaultDate = (0, _moment2.default)().format('YYYY-MM-DD');
...
Typeahead.propTypes = {
  ...
  isChangeValid: _propTypes2.default.func,
